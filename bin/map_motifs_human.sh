...
taipale=$motif_dir/hg38.taipale.1e-4/fimo.combined.1e-4.parsed.starch
uniprobe=$motif_dir/hg38.uniprobe.1e-4/fimo.combined.1e-4.parsed.starch
xfac=$motif_dir/hg38.xfac.1e-4/fimo.combined.1e-4.parsed.starch
jaspar=$motif_dir/hg38.jaspar.1e-4/fimo.combined.1e-4.parsed.starch
